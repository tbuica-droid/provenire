...
> and its four documents are fictional, generated by
> [`scripts/generate-samples.ts`](scripts/generate-samples.ts). No real company,
> deal, or confidential material is included anywhere in this repo or its history.
...
Findings ranked by materiality, tagged by category and type, each carrying a
confidence level, a review-gate control, and a citation.

![Findings dashboard](docs/screenshots/findings-dashboard.png)
...
![Operational cost-out opportunity](docs/screenshots/operational-costout.png)
